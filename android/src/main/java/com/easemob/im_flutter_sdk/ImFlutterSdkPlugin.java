...
public class ImFlutterSdkPlugin {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    registerVoiceRecorderManagerWith(registrar);
  }
  ...
  public static void registerVoiceRecorderManagerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), CHANNEL_PREFIX + "/em_voice_recorder", JSONMethodCodec.INSTANCE);
    channel.setMethodCallHandler(new EMVoiceRecorderWrapper(registrar.context(),channel));
  }
