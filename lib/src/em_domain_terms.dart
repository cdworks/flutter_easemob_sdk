...
class EMMessage {
  ...
  EMMessage.createImageSendMessage(
      ...
      : this(
            ...
            body: EMImageMessageBody.path(filePath, sendOriginalImage),
            to: userName);

  /// 创建视频类型消息 [filePath]: 视频片断路径;  [timeLength]: 语音时长; [userName]: 接收方id
  EMMessage.createVideoSendMessage(
      String filePath, double timeLength, String userName,String thumbUrl, double
  thumbWidth,
      double thumbHeight)
      : this(
            direction: Direction.SEND,
            type: EMMessageType.VIDEO,
            body: EMVideoMessageBody(File(filePath),thumbUrl, timeLength,
  ...
  EMMessage.createFileSendMessage(String filePath, String userName,int fileSize)
      : this(
            direction: Direction.SEND,
            type: EMMessageType.FILE,
            body: EMNormalFileMessageBody(File(filePath),fileSize),
            to: userName);
