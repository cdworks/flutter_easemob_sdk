...
class MediaUtil {
  ...
  Future<Map> takePhoto() async {
    Map info = await ImagePicker.pickImage(source: ImageSource.camera);
//    if (info == null) {
//      return null;
//    }
...
//    }
  ...
  Future<Map> pickImage() async {
    Map info = await ImagePicker.pickImage(source: ImageSource.gallery);
//    if (info == null) {
//      return null;
//    }
//    String imgPath = imgFile.path;
